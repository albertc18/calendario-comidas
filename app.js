...
// El client s'inicialitza dins de init() per garantir que el SDK ja és carregat
let supabase = null;
...
async function setMenuItemInDB(item) {
  if (USE_SUPABASE) {
    // Busquem si ja existeix un registre per a aquest slot (sense necessitar UNIQUE constraint)
